...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference("Tutorial.count") do
      post tutorials_url, params: { tutorial: { name: @tutorial.name, teacher_id: @tutorial.teacher_id } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { name: @tutorial.name, teacher_id: @tutorial.teacher_id } }
