module ApplicationHelper
  ...
  def project_type_icon(project_type)
    ...
    when "Music Theory"
      # Light Bulb
      raw '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-4.5 6.01 6.01 0 00-1.5-4.5m0 9c-.4 0-.777.047-1.133.138m1.133-.138c.356.091.733.138 1.133.138m-2.266-9A6.008 6.008 0 017.5 3.75c0 .36.028.711.082 1.055.054.345.14.674.254.985.115.31.262.602.437.872l.001.002.001.002A6.01 6.01 0 0112 9.75m-6 0a6.01 6.01 0 001.5 4.5 6.01 6.01 0 00-1.5-4.5m0 9c.4 0 .777.047 1.133.138M6 18v-5.25m0 0c.356.091.733.138 1.133.138M18 18v-5.25m0 0a6.01 6.01 0 01-1.5-4.5 6.01 6.01 0 011.5-4.5m0 9c.4 0 .777.047 1.133.138m-1.133-.138c-.356.091-.733.138-1.133.138" />
